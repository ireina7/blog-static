...
function $s_Lblog_Main__main__AT__V(args) {
  $m_Lblog_Main$().main__AT__V(args)
}
/** @constructor */
function $c_Lblog_Main$() {
  this.Lblog_Main$__f_assetsPath = null;
  this.Lblog_Main$__f_content = null;
  this.Lblog_Main$__f_footer = null;
  this.Lblog_Main$__f_searchBar = null;
  this.Lblog_Main$__f_sideBar = null;
  this.Lblog_Main$__f_sideBarWidth = null;
  ...
  var $$x5 = this$2.p__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag("\n\u8fd9\u662f\u4e00\u4e2a\u9996\u9875\u6d4b\u8bd5\uff0c\u76ee\u524d\u95ee\u9898\u8fd8\u6709\u5f88\u591a\uff0c\u89c6\u89c9\u6027\u8f83\u5dee\u3002@%%%%\n\u6211\u662fIreina\uff0c\u6df7\u8ff9\u5728\u4e16\u754c\u5404\u5730\u7684\u65c5\u884c\u9b54\u5973\uff0c\u9047\u5230\u6211\u5c06\u4f1a\u662f\u4f60\u7684\u8363\u5e78\u3002\n      "))])));
  var this$4 = $m_Lscalatags_JsDom$all$();
  var $$x4 = this$4.p__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag("\u9ad8\u4eae\u89e3\u51b3\uff01"))])));
  var this$6 = $m_Lscalatags_JsDom$all$();
  var $$x3 = this$6.p__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag("\u4ee3\u7801\u793a\u4f8b\uff1a"))])));
  var this$8 = $m_Lscalatags_JsDom$all$();
  var $$x2 = this$8.pre__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([])));
  var $$x1 = $m_sr_ScalaRunTime$();
  var this$9 = $m_Lscalatags_JsDom$all$();
  this.Lblog_Main$__f_content = $$x7.apply__sci_Seq__Lscalatags_JsDom$TypedTag($$x6.wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$$x5, $$x4, $$x3, $$x2.apply__sci_Seq__Lscalatags_JsDom$TypedTag($$x1.wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([this$9.code__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$m_Lscalatags_JsDom$all$().class__Lscalatags_generic_Attr().$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("language-scala", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringAttr)]))).apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag("\ndef searchBar: dom.Element = {  \n\nform(cls := \"d-flex\")(  \n    input(\n        `class` := \"form-control me-2\",\n        `type` := \"search\", \n        placeholder := \"search\", \n        attr(\"aria-label\") := \"Search\"\n    ),\n    button(`class` := \"btn btn-outline-success\", `type` := \"submit\")(\"search\")\n)\n}.render\n      "))])))])))]))).render__Lorg_scalajs_dom_raw_Element();
  ...
  var $$x23 = $as_Lscalatags_JsDom$TypedTag($f_Lscalatags_jsdom_TagFactory__typedTag__T__Z__Lscalatags_generic_Namespace__Lscalatags_generic_TypedTag(this$12, "footer", void$1, ns)).apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$m_Lscalatags_JsDom$all$().class__Lscalatags_generic_Attr().$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("text-lg-start", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringAttr), $as_Lscalatags_generic_PixelStyle($m_Lscalatags_JsDom$all$().marginLeft__Lscalatags_generic_StyleMisc$MarginAuto()).$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(30, $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_intPixelStyle)])));
  var $$x22 = $m_sr_ScalaRunTime$();
  var this$13 = $m_Lscalatags_JsDom$all$();
  var $$x21 = this$13.div__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$m_Lscalatags_JsDom$all$().class__Lscalatags_generic_Attr().$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("p-1", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringAttr)])));
  var $$x20 = $m_sr_ScalaRunTime$();
  var this$14 = $m_Lscalatags_JsDom$all$();
  var $$x19 = this$14.p__Lscalatags_JsDom$TypedTag();
  var $$x18 = $m_sr_ScalaRunTime$();
  var this$15 = $m_Lscalatags_JsDom$all$();
  var $$x17 = this$15.i__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag("Powered by "))])));
  var this$17 = $m_Lscalatags_JsDom$all$();
  var $$x16 = this$17.span__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$m_Lscalatags_JsDom$all$().color__Lscalatags_generic_Styles$color$().$colon$eq__O__Lscalatags_generic_StyleValue__Lscalatags_generic_StylePair("red", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringStyle)])));
  var $$x15 = $m_sr_ScalaRunTime$();
  var this$18 = $m_Lscalatags_JsDom$all$();
  var $$x14 = this$18.i__Lscalatags_JsDom$TypedTag();
  var $$x13 = $m_sr_ScalaRunTime$();
  var this$19 = $m_Lscalatags_JsDom$all$();
  var $$x12 = $$x16.apply__sci_Seq__Lscalatags_JsDom$TypedTag($$x15.wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$$x14.apply__sci_Seq__Lscalatags_JsDom$TypedTag($$x13.wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([this$19.b__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag("Scala."))])))])))])));
  var this$21 = $m_Lscalatags_JsDom$all$();
  var $$x11 = this$21.span__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$m_Lscalatags_JsDom$all$().color__Lscalatags_generic_Styles$color$().$colon$eq__O__Lscalatags_generic_StyleValue__Lscalatags_generic_StylePair("orange", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringStyle)])));
  var $$x10 = $m_sr_ScalaRunTime$();
  var this$22 = $m_Lscalatags_JsDom$all$();
  var $$x9 = this$22.i__Lscalatags_JsDom$TypedTag();
  var $$x8 = $m_sr_ScalaRunTime$();
  var this$23 = $m_Lscalatags_JsDom$all$();
  this.Lblog_Main$__f_footer = $$x23.apply__sci_Seq__Lscalatags_JsDom$TypedTag($$x22.wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$$x21.apply__sci_Seq__Lscalatags_JsDom$TypedTag($$x20.wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$$x19.apply__sci_Seq__Lscalatags_JsDom$TypedTag($$x18.wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$$x17, $$x12, $$x11.apply__sci_Seq__Lscalatags_JsDom$TypedTag($$x10.wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$$x9.apply__sci_Seq__Lscalatags_JsDom$TypedTag($$x8.wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([this$23.b__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag("js"))])))])))])))])))])))]))).render__Lorg_scalajs_dom_raw_Element();
  var this$25 = $m_Lscalatags_JsDom$all$();
  var $$x32 = this$25.form__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$m_Lscalatags_JsDom$all$().cls__Lscalatags_generic_Attr().$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("d-flex", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringAttr), $as_Lscalatags_generic_PixelStyle($m_Lscalatags_JsDom$all$().marginLeft__Lscalatags_generic_StyleMisc$MarginAuto()).$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(45, $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_intPixelStyle), $m_Lscalatags_JsDom$all$().bottom__Lscalatags_generic_StyleMisc$PixelAutoStyle().$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(0, $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_intPixelStyle), $as_Lscalatags_generic_PixelStyle($m_Lscalatags_JsDom$all$().marginTop__Lscalatags_generic_StyleMisc$MarginAuto()).$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(30, $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_intPixelStyle), $m_Lscalatags_JsDom$all$().width__Lscalatags_generic_StyleMisc$PixelAutoStyle().$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(600, $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_intPixelStyle)])));
  var $$x31 = $m_sr_ScalaRunTime$();
  var this$26 = $m_Lscalatags_JsDom$all$();
  var $$x30 = this$26.input__Lscalatags_JsDom$TypedTag();
  var $$x29 = $m_sr_ScalaRunTime$();
  var $$x28 = $m_Lscalatags_JsDom$all$().class__Lscalatags_generic_Attr().$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("form-control me-2", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringAttr);
  var $$x27 = $m_Lscalatags_JsDom$all$().type__Lscalatags_generic_Attr().$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("search", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringAttr);
  var $$x26 = $m_Lscalatags_JsDom$all$().height__Lscalatags_generic_StyleMisc$PixelAutoStyle().$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(40, $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_intPixelStyle);
  var $$x25 = $m_Lscalatags_JsDom$all$().placeholder__Lscalatags_generic_Attr().$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("order", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringAttr);
  var this$29 = $m_Lscalatags_JsDom$all$();
  $m_Lscalatags_JsDom$all$();
  var ns$1 = null;
  $m_Lscalatags_JsDom$all$();
  var raw = false;
  var $$x24 = $$x30.apply__sci_Seq__Lscalatags_JsDom$TypedTag($$x29.wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$$x28, $$x27, $$x26, $$x25, $f_Lscalatags_generic_Util__attr__T__Lscalatags_generic_Namespace__Z__Lscalatags_generic_Attr(this$29, "aria-label", ns$1, raw).$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("Search", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringAttr)])));
  var this$30 = $m_Lscalatags_JsDom$all$();
  this.Lblog_Main$__f_searchBar = $$x32.apply__sci_Seq__Lscalatags_JsDom$TypedTag($$x31.wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$$x24, this$30.button__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$m_Lscalatags_JsDom$all$().class__Lscalatags_generic_Attr().$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("btn btn-outline-success", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringAttr), $m_Lscalatags_JsDom$all$().type__Lscalatags_generic_Attr().$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("submit", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringAttr), $m_Lscalatags_JsDom$all$().height__Lscalatags_generic_StyleMisc$PixelAutoStyle().$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(40, $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_intPixelStyle)]))).apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag("summon"))])))]))).render__Lorg_scalajs_dom_raw_Element();
  var this$32 = $m_Lscalatags_JsDom$all$();
  var $$x38 = this$32.div__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$m_Lscalatags_JsDom$all$().id__Lscalatags_generic_Attr().$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("mySidenav", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringAttr), $m_Lscalatags_JsDom$all$().class__Lscalatags_generic_Attr().$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("sidenav", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringAttr)])));
  var $$x37 = $m_sr_ScalaRunTime$();
  var this$33 = $m_Lscalatags_JsDom$all$();
  var $$x36 = this$33.a__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$m_Lscalatags_JsDom$all$().href__Lscalatags_generic_Attr().$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("/", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringAttr)]))).apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag("Home"))])));
  var this$35 = $m_Lscalatags_JsDom$all$();
  var $$x35 = this$35.a__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$m_Lscalatags_JsDom$all$().href__Lscalatags_generic_Attr().$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("/about", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringAttr)]))).apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag("About"))])));
  var this$37 = $m_Lscalatags_JsDom$all$();
  var $$x34 = this$37.a__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$m_Lscalatags_JsDom$all$().href__Lscalatags_generic_Attr().$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("/filter", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringAttr)]))).apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag("Filter"))])));
  var this$39 = $m_Lscalatags_JsDom$all$();
  var $$x33 = this$39.a__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$m_Lscalatags_JsDom$all$().href__Lscalatags_generic_Attr().$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("#", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringAttr)]))).apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag("Category"))])));
  var this$41 = $m_Lscalatags_JsDom$all$();
  this.Lblog_Main$__f_sideBar = $$x38.apply__sci_Seq__Lscalatags_JsDom$TypedTag($$x37.wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$$x36, $$x35, $$x34, $$x33, this$41.a__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$m_Lscalatags_JsDom$all$().href__Lscalatags_generic_Attr().$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("#", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringAttr)]))).apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag("Structure"))])))]))).render__Lorg_scalajs_dom_raw_Element();
  this.Lblog_Main$__f_sideBarWidth = "500px";
  this.Lblog_Main$__f_sideBarShow = false;
  var this$43 = $m_Lscalatags_JsDom$all$();
  var $$x64 = this$43.div__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$m_Lscalatags_JsDom$all$().backgroundImage__Lscalatags_generic_StyleMisc$MultiImageStyle().$colon$eq__O__Lscalatags_generic_StyleValue__Lscalatags_generic_StylePair((("url(" + this.Lblog_Main$__f_assetsPath) + "/img/yuii.jpg)"), $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringStyle), $m_Lscalatags_JsDom$all$().backgroundPosition__Lscalatags_generic_Style().$colon$eq__O__Lscalatags_generic_StyleValue__Lscalatags_generic_StylePair("right bottom", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringStyle), $m_Lscalatags_JsDom$all$().backgroundSize__Lscalatags_generic_Styles$backgroundSize$().$colon$eq__O__Lscalatags_generic_StyleValue__Lscalatags_generic_StylePair("cover", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringStyle)])));
  var $$x63 = $m_sr_ScalaRunTime$();
  var this$45 = $m_Lscalatags_JsDom$all$();
  $m_Lscalatags_JsDom$all$();
  var void$2 = false;
  var ns$2 = $m_Lscalatags_generic_Namespace$().Lscalatags_generic_Namespace$__f_htmlNamespaceConfig;
  var $$x62 = $as_Lscalatags_JsDom$TypedTag($f_Lscalatags_jsdom_TagFactory__typedTag__T__Z__Lscalatags_generic_Namespace__Lscalatags_generic_TypedTag(this$45, "nav", void$2, ns$2)).apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$m_Lscalatags_JsDom$all$().class__Lscalatags_generic_Attr().$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("nav sticky-top", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringAttr), $as_Lscalatags_generic_PixelStyle($m_Lscalatags_JsDom$all$().marginTop__Lscalatags_generic_StyleMisc$MarginAuto()).$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(0, $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_intPixelStyle), $as_Lscalatags_generic_PixelStyle($m_Lscalatags_JsDom$all$().marginLeft__Lscalatags_generic_StyleMisc$MarginAuto()).$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(50, $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_intPixelStyle), $m_Lscalatags_JsDom$all$().height__Lscalatags_generic_StyleMisc$PixelAutoStyle().$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(150, $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_intPixelStyle)])));
  var $$x61 = $m_sr_ScalaRunTime$();
  var this$46 = $m_Lscalatags_JsDom$all$();
  var $$x60 = this$46.div__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$as_Lscalatags_generic_PixelStyle($m_Lscalatags_JsDom$all$().marginTop__Lscalatags_generic_StyleMisc$MarginAuto()).$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(20, $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_intPixelStyle)])));
  var $$x59 = $m_sr_ScalaRunTime$();
  var this$47 = $m_Lscalatags_JsDom$all$();
  var $$x58 = this$47.a__Lscalatags_JsDom$TypedTag();
  var $$x57 = $m_sr_ScalaRunTime$();
  var $$x56 = $m_Lscalatags_JsDom$all$().class__Lscalatags_generic_Attr().$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("navbar-brand", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringAttr);
  var $$x55 = $m_Lscalatags_JsDom$all$().href__Lscalatags_generic_Attr().$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("#", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringAttr);
  var $$x54 = $m_Lscalatags_JsDom$all$().onclick__Lscalatags_generic_Attr();
  var $$x53 = new $c_sjsr_AnonFunction0(((this$48) => (() => {
    if ((!this$48.Lblog_Main$__f_sideBarShow)) {
      this$48.openSideBar__V()
    } else {
      this$48.closeSideBar__V()
    }
  }))(this));
  ...
  var $$x52 = $$x58.apply__sci_Seq__Lscalatags_JsDom$TypedTag($$x57.wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$$x56, $$x55, $$x54.$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair($$x53, new $c_Lscalatags_LowPriorityImplicits$$anon$2(this$49, ev))])));
  var $$x51 = $m_sr_ScalaRunTime$();
  var this$50 = $m_Lscalatags_JsDom$all$();
  var $$x50 = $$x52.apply__sci_Seq__Lscalatags_JsDom$TypedTag($$x51.wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([this$50.img__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$m_Lscalatags_JsDom$all$().class__Lscalatags_generic_Attr().$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("spinner", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringAttr), $m_Lscalatags_JsDom$all$().src__Lscalatags_generic_Attr().$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair((this.Lblog_Main$__f_assetsPath + "/img/lambda-icon-18.jpg"), $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringAttr), $m_Lscalatags_JsDom$all$().width__Lscalatags_generic_StyleMisc$PixelAutoStyle().$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(70, $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_intPixelStyle)])))])));
  var this$51 = $m_Lscalatags_JsDom$all$();
  var $$x49 = this$51.span__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$m_Lscalatags_JsDom$all$().class__Lscalatags_generic_Attr().$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("navbar-text", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringAttr), $m_Lscalatags_JsDom$all$().fontSize__Lscalatags_generic_Styles$fontSize$().$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(30, $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_intPixelStyle)])));
  var $$x48 = $m_sr_ScalaRunTime$();
  var this$52 = $m_Lscalatags_JsDom$all$();
  var $$x47 = this$52.i__Lscalatags_JsDom$TypedTag();
  var $$x46 = $m_sr_ScalaRunTime$();
  var this$53 = $m_Lscalatags_JsDom$all$();
  var $$x45 = this$53.b__Lscalatags_JsDom$TypedTag();
  var $$x44 = $m_sr_ScalaRunTime$();
  var this$54 = $m_Lscalatags_JsDom$all$();
  var $$x43 = $$x60.apply__sci_Seq__Lscalatags_JsDom$TypedTag($$x59.wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$$x50, $$x49.apply__sci_Seq__Lscalatags_JsDom$TypedTag($$x48.wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$$x47.apply__sci_Seq__Lscalatags_JsDom$TypedTag($$x46.wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$$x45.apply__sci_Seq__Lscalatags_JsDom$TypedTag($$x44.wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([this$54.span__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$m_Lscalatags_JsDom$all$().color__Lscalatags_generic_Styles$color$().$colon$eq__O__Lscalatags_generic_StyleValue__Lscalatags_generic_StylePair("purple", $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_stringStyle)]))).apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag("Ireina's "))]))), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag("magic"))])))])))])))])));
  var this$57 = $m_Lscalatags_JsDom$all$();
  var $$x42 = this$57.i__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$m_Lscalatags_JsDom$all$().fontSize__Lscalatags_generic_Styles$fontSize$().$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(20, $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_intPixelStyle)])));
  var $$x41 = $m_sr_ScalaRunTime$();
  var this$58 = $m_Lscalatags_JsDom$all$();
  var $$x40 = $$x62.apply__sci_Seq__Lscalatags_JsDom$TypedTag($$x61.wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$$x43, $$x42.apply__sci_Seq__Lscalatags_JsDom$TypedTag($$x41.wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([this$58.b__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag("TM"))])))])))])));
  var this$60 = $m_Lscalatags_JsDom$all$();
  var e = this.Lblog_Main$__f_searchBar;
  var $$x39 = new $c_Lscalatags_LowPriorityImplicits$bindNode(this$60, e);
  var this$61 = $m_Lscalatags_JsDom$all$();
  this.Lblog_Main$__f_navBar = $$x64.apply__sci_Seq__Lscalatags_JsDom$TypedTag($$x63.wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$$x40, $$x39, this$61.pre__Lscalatags_JsDom$TypedTag().apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([$as_Lscalatags_generic_PixelStyle($m_Lscalatags_JsDom$all$().marginLeft__Lscalatags_generic_StyleMisc$MarginAuto()).$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(55, $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_intPixelStyle), $m_Lscalatags_JsDom$all$().fontSize__Lscalatags_generic_Styles$fontSize$().$colon$eq__O__Lscalatags_generic_PixelStyleValue__Lscalatags_generic_StylePair(18, $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_intPixelStyle)]))).apply__sci_Seq__Lscalatags_JsDom$TypedTag($m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalatags_generic_Modifier.getArrayOf().constr)([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag("\nY = \u03bbf. (\u03bbx. f (x x)) (\u03bbx. f (x x))\n\ntrait Monad[M[_]] {\n  def pure[A](a: A): M[A]\n  extension [A](ma: M[A]) def flatMap[B](f: A => M[B]): M[B]\n}\n        "))])))]))).render__Lorg_scalajs_dom_raw_Element()
}
$c_Lblog_Main$.prototype = new $h_O();
$c_Lblog_Main$.prototype.constructor = $c_Lblog_Main$;
/** @constructor */
function $h_Lblog_Main$() {
  /*<skip>*/
}
$h_Lblog_Main$.prototype = $c_Lblog_Main$.prototype;
$c_Lblog_Main$.prototype.main__AT__V = (function(args) {
  var this$2 = $m_s_Console$();
  var this$3 = this$2.out__Ljava_io_PrintStream();
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V("Hello world!\n");
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().addEventListener("DOMContentLoaded", ((this$4) => ((e) => {
    this$4.setup__V()
  }))(this))
});
$c_Lblog_Main$.prototype.setup__V = (function() {
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().body.appendChild(this.Lblog_Main$__f_sideBar);
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("blog-navigator").appendChild(this.Lblog_Main$__f_navBar);
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("blog-footer").appendChild(this.Lblog_Main$__f_footer)
});
$c_Lblog_Main$.prototype.isStatic__Z = (function() {
  return ($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("static-content") !== null)
});
$c_Lblog_Main$.prototype.openSideBar__V = (function() {
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("mySidenav").style.width = this.Lblog_Main$__f_sideBarWidth;
  this.Lblog_Main$__f_sideBarShow = true
});
$c_Lblog_Main$.prototype.closeSideBar__V = (function() {
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("mySidenav").style.width = "0";
  this.Lblog_Main$__f_sideBarShow = false
});
$c_Lblog_Main$.prototype.$js$exported$prop$sideBarWidth__O = (function() {
  return this.Lblog_Main$__f_sideBarWidth
});
$c_Lblog_Main$.prototype.$js$exported$prop$sideBarShow__O = (function() {
  return this.Lblog_Main$__f_sideBarShow
});
$c_Lblog_Main$.prototype.$js$exported$prop$sideBarShow__Z__O = (function(x$1) {
  this.Lblog_Main$__f_sideBarShow = x$1
});
$c_Lblog_Main$.prototype.$js$exported$meth$openSideBar__O = (function() {
  this.openSideBar__V()
});
...
Object.defineProperty($c_Lblog_Main$.prototype, "sideBarShow", {
  ...
  "set": (function(arg) {
    var prep0 = $uZ(arg);
    this.$js$exported$prop$sideBarShow__Z__O(prep0)
  }),
  "configurable": true
});
...
$c_Lblog_Main$.prototype.$classData = $d_Lblog_Main$;
var $n_Lblog_Main$;
function $m_Lblog_Main$() {
  if ((!$n_Lblog_Main$)) {
    $n_Lblog_Main$ = new $c_Lblog_Main$()
  };
  return $n_Lblog_Main$
}
/** @constructor */
...
function $ct_Lscalatags_generic_StyleMisc$CurrentColor__Lscalatags_generic_StyleMisc__T__T__($thiz, outer, jsName, cssName) {
  if ((outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    $thiz.Lscalatags_generic_StyleMisc$CurrentColor__f_$outer = outer
  };
  $ct_Lscalatags_generic_Style__T__T__($thiz, jsName, cssName);
  return $thiz
}
/** @constructor */
function $c_Lscalatags_generic_StyleMisc$CurrentColor() {
  this.Lscalatags_generic_Style__f_jsName = null;
  this.Lscalatags_generic_Style__f_cssName = null;
  this.Lscalatags_generic_StyleMisc$CurrentColor__f_currentColor = null;
  this.Lscalatags_generic_StyleMisc$CurrentColor__f_bitmap$0 = false;
  this.Lscalatags_generic_StyleMisc$CurrentColor__f_$outer = null
}
$c_Lscalatags_generic_StyleMisc$CurrentColor.prototype = new $h_Lscalatags_generic_Style();
$c_Lscalatags_generic_StyleMisc$CurrentColor.prototype.constructor = $c_Lscalatags_generic_StyleMisc$CurrentColor;
/** @constructor */
function $h_Lscalatags_generic_StyleMisc$CurrentColor() {
  /*<skip>*/
}
$h_Lscalatags_generic_StyleMisc$CurrentColor.prototype = $c_Lscalatags_generic_StyleMisc$CurrentColor.prototype;
/** @constructor */
function $c_Lscalatags_generic_StyleMisc$MultiImageStyle(outer, jsName, cssName) {
  this.Lscalatags_generic_Style__f_jsName = null;
  this.Lscalatags_generic_Style__f_cssName = null;
  this.Lscalatags_generic_StyleMisc$MultiImageStyle__f_$outer = null;
  if ((outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.Lscalatags_generic_StyleMisc$MultiImageStyle__f_$outer = outer
  };
...
/** @constructor */
function $c_Lscalatags_generic_Styles$backgroundSize$(outer) {
  this.Lscalatags_generic_Style__f_jsName = null;
  this.Lscalatags_generic_Style__f_cssName = null;
  this.Lscalatags_generic_Styles$backgroundSize$__f_auto = null;
  this.Lscalatags_generic_Styles$backgroundSize$__f_cover = null;
  this.Lscalatags_generic_Styles$backgroundSize$__f_contain = null;
  this.Lscalatags_generic_Styles$backgroundSize$__f_bitmap$0 = 0;
  this.Lscalatags_generic_Styles$backgroundSize$__f_$outer = null;
  if ((outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.Lscalatags_generic_Styles$backgroundSize$__f_$outer = outer
  };
  $ct_Lscalatags_generic_Style__T__T__(this, "backgroundSize", "background-size")
}
$c_Lscalatags_generic_Styles$backgroundSize$.prototype = new $h_Lscalatags_generic_Style();
$c_Lscalatags_generic_Styles$backgroundSize$.prototype.constructor = $c_Lscalatags_generic_Styles$backgroundSize$;
/** @constructor */
function $h_Lscalatags_generic_Styles$backgroundSize$() {
  /*<skip>*/
}
$h_Lscalatags_generic_Styles$backgroundSize$.prototype = $c_Lscalatags_generic_Styles$backgroundSize$.prototype;
var $d_Lscalatags_generic_Styles$backgroundSize$ = new $TypeData().initClass({
  Lscalatags_generic_Styles$backgroundSize$: 0
}, false, "scalatags.generic.Styles$backgroundSize$", {
  Lscalatags_generic_Styles$backgroundSize$: 1,
  Lscalatags_generic_Style: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Lscalatags_generic_Styles$backgroundSize$.prototype.$classData = $d_Lscalatags_generic_Styles$backgroundSize$;
/** @constructor */
function $c_Lscalatags_generic_Styles$fontSize$(outer) {
  this.Lscalatags_generic_PixelStyle__f_jsName = null;
  this.Lscalatags_generic_PixelStyle__f_cssName = null;
  this.Lscalatags_generic_PixelStyle__f_realStyle = null;
  this.Lscalatags_generic_Styles$fontSize$__f_xx$minussmall = null;
  this.Lscalatags_generic_Styles$fontSize$__f_x$minussmall = null;
  this.Lscalatags_generic_Styles$fontSize$__f_small = null;
  this.Lscalatags_generic_Styles$fontSize$__f_medium = null;
  this.Lscalatags_generic_Styles$fontSize$__f_large = null;
  this.Lscalatags_generic_Styles$fontSize$__f_x$minuslarge = null;
  this.Lscalatags_generic_Styles$fontSize$__f_xx$minuslarge = null;
  this.Lscalatags_generic_Styles$fontSize$__f_larger = null;
  this.Lscalatags_generic_Styles$fontSize$__f_smaller = null;
  this.Lscalatags_generic_Styles$fontSize$__f_bitmap$0 = 0;
  this.Lscalatags_generic_Styles$fontSize$__f_$outer = null;
  if ((outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.Lscalatags_generic_Styles$fontSize$__f_$outer = outer
  };
  $ct_Lscalatags_generic_PixelStyle__T__T__(this, "fontSize", "font-size")
}
$c_Lscalatags_generic_Styles$fontSize$.prototype = new $h_Lscalatags_generic_PixelStyle();
$c_Lscalatags_generic_Styles$fontSize$.prototype.constructor = $c_Lscalatags_generic_Styles$fontSize$;
/** @constructor */
function $h_Lscalatags_generic_Styles$fontSize$() {
  /*<skip>*/
}
$h_Lscalatags_generic_Styles$fontSize$.prototype = $c_Lscalatags_generic_Styles$fontSize$.prototype;
var $d_Lscalatags_generic_Styles$fontSize$ = new $TypeData().initClass({
...
$c_Lscalatags_generic_Styles$fontSize$.prototype.$classData = $d_Lscalatags_generic_Styles$fontSize$;
...
/** @constructor */
function $c_Lscalatags_generic_Styles$$anon$2(outer) {
  this.Lscalatags_generic_PixelStyle__f_jsName = null;
  this.Lscalatags_generic_PixelStyle__f_cssName = null;
  this.Lscalatags_generic_PixelStyle__f_realStyle = null;
  this.Lscalatags_generic_Styles$$anon$2__f_auto = null;
  this.Lscalatags_generic_Styles$$anon$2__f_bitmap$0 = false;
  this.Lscalatags_generic_Styles$$anon$2__f_$outer = null;
  if ((outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.Lscalatags_generic_Styles$$anon$2__f_$outer = outer
  };
  $ct_Lscalatags_generic_PixelStyle__T__T__(this, "marginTop", "margin-top")
}
...
/** @constructor */
function $c_Lscalatags_generic_Styles$color$(outer) {
  this.Lscalatags_generic_Style__f_jsName = null;
  this.Lscalatags_generic_Style__f_cssName = null;
  this.Lscalatags_generic_StyleMisc$CurrentColor__f_currentColor = null;
  this.Lscalatags_generic_StyleMisc$CurrentColor__f_bitmap$0 = false;
  this.Lscalatags_generic_StyleMisc$CurrentColor__f_$outer = null;
  this.Lscalatags_generic_Styles$color$__f_black = null;
  this.Lscalatags_generic_Styles$color$__f_silver = null;
  this.Lscalatags_generic_Styles$color$__f_gray = null;
  this.Lscalatags_generic_Styles$color$__f_white = null;
  this.Lscalatags_generic_Styles$color$__f_maroon = null;
  this.Lscalatags_generic_Styles$color$__f_red = null;
  this.Lscalatags_generic_Styles$color$__f_purple = null;
  this.Lscalatags_generic_Styles$color$__f_fuschia = null;
  this.Lscalatags_generic_Styles$color$__f_green = null;
  this.Lscalatags_generic_Styles$color$__f_lime = null;
  this.Lscalatags_generic_Styles$color$__f_olive = null;
  this.Lscalatags_generic_Styles$color$__f_yellow = null;
  this.Lscalatags_generic_Styles$color$__f_navy = null;
  this.Lscalatags_generic_Styles$color$__f_blue = null;
  this.Lscalatags_generic_Styles$color$__f_teal = null;
  this.Lscalatags_generic_Styles$color$__f_aqua = null;
  this.Lscalatags_generic_Styles$color$__f_bitmap$0 = 0;
  $ct_Lscalatags_generic_StyleMisc$CurrentColor__Lscalatags_generic_StyleMisc__T__T__(this, outer, "color", "color")
}
$c_Lscalatags_generic_Styles$color$.prototype = new $h_Lscalatags_generic_StyleMisc$CurrentColor();
$c_Lscalatags_generic_Styles$color$.prototype.constructor = $c_Lscalatags_generic_Styles$color$;
/** @constructor */
function $h_Lscalatags_generic_Styles$color$() {
  /*<skip>*/
}
$h_Lscalatags_generic_Styles$color$.prototype = $c_Lscalatags_generic_Styles$color$.prototype;
var $d_Lscalatags_generic_Styles$color$ = new $TypeData().initClass({
  Lscalatags_generic_Styles$color$: 0
}, false, "scalatags.generic.Styles$color$", {
  Lscalatags_generic_Styles$color$: 1,
  Lscalatags_generic_StyleMisc$CurrentColor: 1,
  Lscalatags_generic_Style: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Lscalatags_generic_Styles$color$.prototype.$classData = $d_Lscalatags_generic_Styles$color$;
...
function $p_Lscalatags_JsDom$all$__pre$lzycompute__Lscalatags_JsDom$TypedTag($thiz) {
  var b = $thiz.Lscalatags_JsDom$all$__f_bitmap$0;
  var lo = (131072 & b.RTLong__f_lo);
  if ((lo === 0)) {
    var ns = $m_Lscalatags_generic_Namespace$().Lscalatags_generic_Namespace$__f_htmlNamespaceConfig;
    $thiz.Lscalatags_JsDom$all$__f_pre = $as_Lscalatags_JsDom$TypedTag($f_Lscalatags_jsdom_TagFactory__typedTag__T__Z__Lscalatags_generic_Namespace__Lscalatags_generic_TypedTag($thiz, "pre", false, ns));
    var b$1 = $thiz.Lscalatags_JsDom$all$__f_bitmap$0;
    var lo$1 = (131072 | b$1.RTLong__f_lo);
    var hi = b$1.RTLong__f_hi;
    $thiz.Lscalatags_JsDom$all$__f_bitmap$0 = new $c_RTLong(lo$1, hi)
  };
  return $thiz.Lscalatags_JsDom$all$__f_pre
}
...
function $p_Lscalatags_JsDom$all$__code$lzycompute__Lscalatags_JsDom$TypedTag($thiz) {
  var b = $thiz.Lscalatags_JsDom$all$__f_bitmap$0;
  var hi = (4 & b.RTLong__f_hi);
  if ((hi === 0)) {
    var ns = $m_Lscalatags_generic_Namespace$().Lscalatags_generic_Namespace$__f_htmlNamespaceConfig;
    $thiz.Lscalatags_JsDom$all$__f_code = $as_Lscalatags_JsDom$TypedTag($f_Lscalatags_jsdom_TagFactory__typedTag__T__Z__Lscalatags_generic_Namespace__Lscalatags_generic_TypedTag($thiz, "code", false, ns));
    var b$1 = $thiz.Lscalatags_JsDom$all$__f_bitmap$0;
    var lo = b$1.RTLong__f_lo;
    var hi$1 = (4 | b$1.RTLong__f_hi);
    $thiz.Lscalatags_JsDom$all$__f_bitmap$0 = new $c_RTLong(lo, hi$1)
  };
  return $thiz.Lscalatags_JsDom$all$__f_code
}
...
function $p_Lscalatags_JsDom$all$__form$lzycompute__Lscalatags_JsDom$TypedTag($thiz) {
  var b = $thiz.Lscalatags_JsDom$all$__f_bitmap$1;
  var lo = (8 & b.RTLong__f_lo);
  if ((lo === 0)) {
    var ns = $m_Lscalatags_generic_Namespace$().Lscalatags_generic_Namespace$__f_htmlNamespaceConfig;
    $thiz.Lscalatags_JsDom$all$__f_form = $as_Lscalatags_JsDom$TypedTag($f_Lscalatags_jsdom_TagFactory__typedTag__T__Z__Lscalatags_generic_Namespace__Lscalatags_generic_TypedTag($thiz, "form", false, ns));
  ...
  return $thiz.Lscalatags_JsDom$all$__f_form
}
...
function $p_Lscalatags_JsDom$all$__backgroundPosition$lzycompute__Lscalatags_generic_Style($thiz) {
  var b = $thiz.Lscalatags_JsDom$all$__f_bitmap$1;
  var lo = (65536 & b.RTLong__f_lo);
  if ((lo === 0)) {
    $thiz.Lscalatags_JsDom$all$__f_backgroundPosition = $ct_Lscalatags_generic_Style__T__T__(new $c_Lscalatags_generic_Style(), "backgroundPosition", "background-position");
    var b$1 = $thiz.Lscalatags_JsDom$all$__f_bitmap$1;
    var lo$1 = (65536 | b$1.RTLong__f_lo);
    var hi = b$1.RTLong__f_hi;
    $thiz.Lscalatags_JsDom$all$__f_bitmap$1 = new $c_RTLong(lo$1, hi)
  };
  return $thiz.Lscalatags_JsDom$all$__f_backgroundPosition
}
function $p_Lscalatags_JsDom$all$__backgroundImage$lzycompute__Lscalatags_generic_StyleMisc$MultiImageStyle($thiz) {
  var b = $thiz.Lscalatags_JsDom$all$__f_bitmap$1;
  var lo = (262144 & b.RTLong__f_lo);
  if ((lo === 0)) {
    $thiz.Lscalatags_JsDom$all$__f_backgroundImage = new $c_Lscalatags_generic_StyleMisc$MultiImageStyle($thiz, "backgroundImage", "background-image");
    var b$1 = $thiz.Lscalatags_JsDom$all$__f_bitmap$1;
    var lo$1 = (262144 | b$1.RTLong__f_lo);
    var hi = b$1.RTLong__f_hi;
    $thiz.Lscalatags_JsDom$all$__f_bitmap$1 = new $c_RTLong(lo$1, hi)
  };
  return $thiz.Lscalatags_JsDom$all$__f_backgroundImage
}
function $p_Lscalatags_JsDom$all$__height$lzycompute__Lscalatags_generic_StyleMisc$PixelAutoStyle($thiz) {
  var b = $thiz.Lscalatags_JsDom$all$__f_bitmap$1;
  var hi = (16384 & b.RTLong__f_hi);
  if ((hi === 0)) {
    $thiz.Lscalatags_JsDom$all$__f_height = new $c_Lscalatags_generic_StyleMisc$PixelAutoStyle($thiz, "height", "height");
    var b$1 = $thiz.Lscalatags_JsDom$all$__f_bitmap$1;
    var lo = b$1.RTLong__f_lo;
    var hi$1 = (16384 | b$1.RTLong__f_hi);
...
function $p_Lscalatags_JsDom$all$__marginTop$lzycompute__Lscalatags_generic_StyleMisc$MarginAuto($thiz) {
  var b = $thiz.Lscalatags_JsDom$all$__f_bitmap$2;
  var lo = (1 & b.RTLong__f_lo);
  if ((lo === 0)) {
    $thiz.Lscalatags_JsDom$all$__f_marginTop = new $c_Lscalatags_generic_Styles$$anon$2($thiz);
  ...
  return $thiz.Lscalatags_JsDom$all$__f_marginTop
}
...
function $p_Lscalatags_JsDom$all$__bottom$lzycompute__Lscalatags_generic_StyleMisc$PixelAutoStyle($thiz) {
  var b = $thiz.Lscalatags_JsDom$all$__f_bitmap$2;
  var lo = (16 & b.RTLong__f_lo);
  if ((lo === 0)) {
    $thiz.Lscalatags_JsDom$all$__f_bottom = new $c_Lscalatags_generic_StyleMisc$PixelAutoStyle($thiz, "bottom", "bottom");
    var b$1 = $thiz.Lscalatags_JsDom$all$__f_bitmap$2;
    var lo$1 = (16 | b$1.RTLong__f_lo);
    var hi = b$1.RTLong__f_hi;
    $thiz.Lscalatags_JsDom$all$__f_bitmap$2 = new $c_RTLong(lo$1, hi)
  };
  return $thiz.Lscalatags_JsDom$all$__f_bottom
}
...
function $p_Lscalatags_JsDom$all$__placeholder$lzycompute__Lscalatags_generic_Attr($thiz) {
  var b = $thiz.Lscalatags_JsDom$all$__f_bitmap$4;
  var lo = (32768 & b.RTLong__f_lo);
  if ((lo === 0)) {
    $thiz.Lscalatags_JsDom$all$__f_placeholder = $f_Lscalatags_generic_Util__attr__T__Lscalatags_generic_Namespace__Z__Lscalatags_generic_Attr($thiz, "placeholder", null, false);
    var b$1 = $thiz.Lscalatags_JsDom$all$__f_bitmap$4;
    var lo$1 = (32768 | b$1.RTLong__f_lo);
    var hi = b$1.RTLong__f_hi;
    $thiz.Lscalatags_JsDom$all$__f_bitmap$4 = new $c_RTLong(lo$1, hi)
  };
  return $thiz.Lscalatags_JsDom$all$__f_placeholder
}
...
function $p_Lscalatags_JsDom$all$__backgroundSize$lzycompute$2__V($thiz) {
  if (($m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_backgroundSize$module === null)) {
    $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_backgroundSize$module = new $c_Lscalatags_generic_Styles$backgroundSize$($thiz)
  }
}
function $p_Lscalatags_JsDom$all$__color$lzycompute$2__V($thiz) {
  if (($m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_color$module === null)) {
    $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_color$module = new $c_Lscalatags_generic_Styles$color$($thiz)
  }
}
function $p_Lscalatags_JsDom$all$__fontSize$lzycompute$2__V($thiz) {
  if (($m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_fontSize$module === null)) {
    $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_fontSize$module = new $c_Lscalatags_generic_Styles$fontSize$($thiz)
  }
}
/** @constructor */
...
$c_Lscalatags_JsDom$all$.prototype.pre__Lscalatags_JsDom$TypedTag = (function() {
  var b = this.Lscalatags_JsDom$all$__f_bitmap$0;
  var lo = (131072 & b.RTLong__f_lo);
  if ((lo === 0)) {
    return $p_Lscalatags_JsDom$all$__pre$lzycompute__Lscalatags_JsDom$TypedTag(this)
  } else {
    return this.Lscalatags_JsDom$all$__f_pre
  }
});
...
$c_Lscalatags_JsDom$all$.prototype.code__Lscalatags_JsDom$TypedTag = (function() {
  var b = this.Lscalatags_JsDom$all$__f_bitmap$0;
  var hi = (4 & b.RTLong__f_hi);
  if ((hi === 0)) {
    return $p_Lscalatags_JsDom$all$__code$lzycompute__Lscalatags_JsDom$TypedTag(this)
  } else {
    return this.Lscalatags_JsDom$all$__f_code
  }
});
...
$c_Lscalatags_JsDom$all$.prototype.form__Lscalatags_JsDom$TypedTag = (function() {
  ...
  var lo = (8 & b.RTLong__f_lo);
  if ((lo === 0)) {
    return $p_Lscalatags_JsDom$all$__form$lzycompute__Lscalatags_JsDom$TypedTag(this)
  } else {
    return this.Lscalatags_JsDom$all$__f_form
  }
});
...
$c_Lscalatags_JsDom$all$.prototype.backgroundPosition__Lscalatags_generic_Style = (function() {
  var b = this.Lscalatags_JsDom$all$__f_bitmap$1;
  var lo = (65536 & b.RTLong__f_lo);
  if ((lo === 0)) {
    return $p_Lscalatags_JsDom$all$__backgroundPosition$lzycompute__Lscalatags_generic_Style(this)
  } else {
    return this.Lscalatags_JsDom$all$__f_backgroundPosition
  }
});
$c_Lscalatags_JsDom$all$.prototype.backgroundSize__Lscalatags_generic_Styles$backgroundSize$ = (function() {
  if (($m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_backgroundSize$module === null)) {
    $p_Lscalatags_JsDom$all$__backgroundSize$lzycompute$2__V(this)
  };
  return $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_backgroundSize$module
});
$c_Lscalatags_JsDom$all$.prototype.backgroundImage__Lscalatags_generic_StyleMisc$MultiImageStyle = (function() {
  var b = this.Lscalatags_JsDom$all$__f_bitmap$1;
  var lo = (262144 & b.RTLong__f_lo);
  if ((lo === 0)) {
    return $p_Lscalatags_JsDom$all$__backgroundImage$lzycompute__Lscalatags_generic_StyleMisc$MultiImageStyle(this)
  } else {
    return this.Lscalatags_JsDom$all$__f_backgroundImage
  }
});
$c_Lscalatags_JsDom$all$.prototype.color__Lscalatags_generic_Styles$color$ = (function() {
  if (($m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_color$module === null)) {
    $p_Lscalatags_JsDom$all$__color$lzycompute$2__V(this)
  };
  return $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_color$module
});
...
$c_Lscalatags_JsDom$all$.prototype.fontSize__Lscalatags_generic_Styles$fontSize$ = (function() {
  ...
  return $m_Lscalatags_JsDom$all$().Lscalatags_JsDom$all$__f_fontSize$module
});
...
$c_Lscalatags_JsDom$all$.prototype.marginTop__Lscalatags_generic_StyleMisc$MarginAuto = (function() {
  var b = this.Lscalatags_JsDom$all$__f_bitmap$2;
  var lo = (1 & b.RTLong__f_lo);
  if ((lo === 0)) {
    return $p_Lscalatags_JsDom$all$__marginTop$lzycompute__Lscalatags_generic_StyleMisc$MarginAuto(this)
  } else {
    return this.Lscalatags_JsDom$all$__f_marginTop
  }
});
...
$c_Lscalatags_JsDom$all$.prototype.bottom__Lscalatags_generic_StyleMisc$PixelAutoStyle = (function() {
  var b = this.Lscalatags_JsDom$all$__f_bitmap$2;
  var lo = (16 & b.RTLong__f_lo);
  if ((lo === 0)) {
    return $p_Lscalatags_JsDom$all$__bottom$lzycompute__Lscalatags_generic_StyleMisc$PixelAutoStyle(this)
  } else {
    return this.Lscalatags_JsDom$all$__f_bottom
  }
});
...
$c_Lscalatags_JsDom$all$.prototype.placeholder__Lscalatags_generic_Attr = (function() {
  ...
  var lo = (32768 & b.RTLong__f_lo);
  if ((lo === 0)) {
    return $p_Lscalatags_JsDom$all$__placeholder$lzycompute__Lscalatags_generic_Attr(this)
  } else {
    return this.Lscalatags_JsDom$all$__f_placeholder
  }
});
...
$d_J.zero = $L0;
blog = $m_Lblog_Main$();
$s_Lblog_Main__main__AT__V(new ($d_T.getArrayOf().constr)([]));
}).call(this);
